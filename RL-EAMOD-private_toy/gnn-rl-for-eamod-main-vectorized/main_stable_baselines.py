...
def main():
    ...
    model = PPO(CustomActorCriticPolicy, gym_env,
                policy_kwargs=policy_kwargs, verbose=0, batch_size=64)
    # model = PPO.load("model_"+str(1)+".json", env=gym_env)

    # model = SAC(CustomActorCriticPolicy, gym_env,
    #             policy_kwargs=policy_kwargs, verbose=1, batch_size=64)

    # model = SAC("MlpPolicy", gym_env,
    #             policy_kwargs=policy_kwargs, verbose=1, batch_size=64)
