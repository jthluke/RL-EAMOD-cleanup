...
class GNNActor(nn.Module):
    ...
    # GAT implementation
    def __init__(self, in_channels, dim_h=16, out_channels=2, heads=12, dropout_rate=0):
        super().__init__()
...
class GNNCritic(nn.Module):
    ...
    # GAT implementation
    def __init__(self, in_channels, dim_h=16, out_channels=1, heads=12, dropout_rate=0):
        super().__init__()
        self.gat1 = GATv2Conv(in_channels, dim_h, heads=heads)
        self.gat2 = GATv2Conv(dim_h * heads, dim_h, heads=heads)
        self.gat3 = GATv2Conv(dim_h * heads, out_channels, heads=1)
